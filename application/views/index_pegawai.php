...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<?=base_url()?>index.php/Dashboard"><img src="<?=base_url()?>assets/img/sarpra2.png" alt="Sarpra Logo" class="img-responsive logo"></a>
			</div>
			...
			<div class="navbar-btn">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?=base_url()?>assets/img/hima.jpg" class="img-circle" alt="Avatar"> <span>Hima</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
